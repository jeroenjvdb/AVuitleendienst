...
$config = array(
    'KdG' => array(
        'saml:SP',
        'entityID' => null,
/*        'RelayState' => 'https://jeroenvandenbroeck.mctantwerpen.kdg.be/simplesaml/simplesamlphp-1.13.2/www/module.php/core/authenticate.php?as=myauth',
*/
        'idp' => 'http://sts.kdg.be/adfs/services/trust',
        'discoURL' => null,
    ),
